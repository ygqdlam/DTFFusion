...
class MainNet(nn.Module):
    ...
    def forward(self, x, S=None, T_lv3=None, T_lv2=None, T_lv1=None):
        ...
        x0,x_original = self.SFE(x)

        if self.should_reset:
            x3 = x_original  ###80*80
            x2 =  F.interpolate(x3, scale_factor=0.5, mode='bicubic',align_corners=True)     ###40*40
            x1 = F.interpolate(x3, scale_factor=0.25, mode='bicubic',align_corners=True)  ###20*20
            save_list = []
