...
class TTSR(nn.Module):
    ...
    def forward(self, lr=None, lrsr=None, ref_1=None, refsr_1=None, sr=None,ref_2=None,refsr_2=None,val = False):
        ...
        for _ in range(self.args.num_steps):
            sr = self.MainNet(lr, S, T_lv3, T_lv2, T_lv1,ref_lv1, ref_lv2, ref_lv3)
        ...
        if(self.args.refs == 2):
            ...
            S_2, T_2_lv3, T_2_lv2, T_2_lv1 = self.SearchTransfer(lrsr_lv3, refsr_2_lv3, ref_2_lv1, ref_2_lv2,
                                                                 ref_2_lv3)
            ...
            self.MainNet.reset_state()
            for _ in range(self.args.num_steps):
                sr_2 = self.MainNet(lr, S_2, T_2_lv3, T_2_lv2, T_2_lv1,ref_lv1, ref_lv2, ref_lv3)
